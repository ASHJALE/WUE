...
async def main():
    ...
    os.environ["FURNITURE_DEVELOPMENT_FALLBACK_ENABLED"] = "true"
    os.environ["FURNITURE_MODEL_PATH"] = "models/nonexistent-phase73-model.onnx"
    ...
    with tempfile.TemporaryDirectory(prefix="wue-phase73-") as temporary:
        ...
        try:
            ...
            assert first["model_name"] == "wue-furniture-classifier"
            assert first["model"]["mode"] == "development_fallback"
            ...
            assert "corrupted" in corrupt_response["detail"]
